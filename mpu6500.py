...
#_ACCEL_FS_MASK = const(0x18)
ACCEL_FS_SEL_2G = const(0)
ACCEL_FS_SEL_4G = const(0x8)
ACCEL_FS_SEL_8G = const(0x10)
ACCEL_FS_SEL_16G = const(0x18)
...
GYRO_FS_SEL_500DPS = const(0x8)
GYRO_FS_SEL_1000DPS = const(0x10)
GYRO_FS_SEL_2000DPS = const(0x18)
...
_I2C_BYPASS_MASK = const(0x2)
_I2C_BYPASS_EN = const(0x2)
